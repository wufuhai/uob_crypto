...
public class Program {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            String encryptedText = AesCrypto.rsaEncrypt(shortMessage, rsaKeyPair.getPublic());

            String decryptedText = AesCrypto.rsaDecrypt(Base64.getDecoder().decode(encryptedText), rsaKeyPair.getPrivate()) ;
